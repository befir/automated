...
public class queryChannelinventory extends PageAutomatedTest {
    @Test
    public void gotoProductManagePage() throws InterruptedException {
        ...
        driverWait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("库存中心").xpath("//span[text()='渠道库存管理']")));
        List<WebElement> elements = driver.findElement(By.linkText("库存中心")).findElements(By.xpath("//span[text()='渠道库存管理']"));
    ...
    @Test
    public void queryChannelinventory() throws InterruptedException {
        gotoProductManagePage();
        Actions action = new Actions(driver);
        driver.switchTo().frame(driver.findElement(By.id("STOCK_CHANNEL_8frame")));
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//select[contains(@ng-model,'queryParam.channelCode')]")).findElements(By.tagName("option")).get(1).click();
        Thread.sleep(1000);
