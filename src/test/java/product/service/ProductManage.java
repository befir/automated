...
public class ProductManage extends RestfulAutomatedTest {
    ...
    //接口
    private String queryProductInfoByPageUrl = baseUrl + "/back-merchant-web/registerMerchant/queryRegisterMerchantPageInfo.do";
...
//    private String updateMerchantOrgBaseInfoByIdUrl1 = baseUrl + "";
    ...
    public void queryMerchantOrgCode() throws InterruptedException {
        ...
        Object o = Ajax.post(driver, queryProductInfoByPageUrl, param);
...
//        String merchantCode= listObj.getJSONObject(0).getString("merchantCode");
        ...
        String expectedData ="桂源铺";
        String expectedData1 ="spx101701";
        String expectedData2= "org_name_is_exist";
//        Assert.assertEquals(merchantName,expectedData);
//        Assert.assertEquals(merchantCode,expectedData1);
        Assert.assertEquals(actualResult.get("code"),expectedData2);
//        System.out.println(merchantCode);
